package com.chslcompany.nearbyrocketseat.ui.components.welcome
...
fun WelcomeHowItWorksTip(
    ...
    Row(
        ...
        Column(
            ...
            Text(text = title, style = MyTypography.headlineSmall)
            Text(text = subtitle, color = Gray500, style = MyTypography.bodyLarge)
        }
    }
}